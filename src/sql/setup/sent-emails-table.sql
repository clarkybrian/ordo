...
-- Table pour stocker les emails envoyés depuis Orton
...
-- Politique : utilisateurs peuvent seulement voir/modifier leurs propres emails envoyés
-- Utilisation de CREATE OR REPLACE pour éviter les erreurs de doublons
